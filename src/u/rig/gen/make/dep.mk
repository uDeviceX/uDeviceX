...
$B/algo/minmax/imp.o: $S/inc/conf.h $S/inc/type.h $S/d/q.h $S/algo/minmax/imp.h $S/inc/def.h $S/algo/utils/shfl.h $S/inc/dev.h $S/d/api.h $B/conf.h $S/algo/utils/dev.h $S/utils/kl.h $S/struct/particle/dev.h $S/d/ker.h $S/utils/msg.h
...
$B/algo/scan/imp.o: $S/algo/scan/cpu/imp.h $S/utils/imp.h $S/inc/conf.h $S/utils/error.h $S/d/q.h $S/algo/scan/imp.h $S/utils/cc.h $S/algo/scan/dev.h $S/algo/utils/shfl.h $S/d/api.h $S/inc/dev.h $B/conf.h $S/utils/kl.h $S/algo/scan/cuda/type.h $S/algo/scan/cpu/type.h $S/algo/scan/cuda/imp.h $S/d/ker.h
...
$B/exch/map/imp.o: $S/utils/imp.h $S/inc/conf.h $S/utils/error.h $S/exch/map/imp.h $S/utils/cc.h $S/algo/utils/shfl.h $S/d/api.h $S/inc/dev.h $B/conf.h $S/exch/map/type.h $S/utils/kl.h $S/exch/map/dev/main.h
$B/exch/mesh/imp.o: $S/exch/mesh/imp/fin.h $S/exch/common/imp.h $S/exch/map/dev.h $S/comm/imp.h $S/utils/imp.h $S/inc/conf.h $S/utils/error.h $S/exch/mesh/imp/com.h $S/exch/map/imp.h $S/comm/utils.h $S/inc/type.h $S/exch/mesh/imp.h $S/utils/cc.h $S/exch/mesh/dev.h $S/algo/minmax/imp.h $S/exch/mesh/imp/ini.h $S/algo/utils/shfl.h $S/d/api.h $S/inc/dev.h $B/conf.h $S/exch/mesh/imp/unpack.h $S/exch/mesh/imp/type.h $S/exch/map/type.h $S/utils/kl.h $S/frag/dev.h $S/exch/mesh/imp/pack.h $S/exch/mesh/imp/map.h $S/frag/imp.h $S/utils/msg.h
...
$B/rigid/imp.o: $S/utils/imp.h $S/inc/conf.h $S/utils/error.h $S/inc/type.h $S/rigid/imp.h $S/utils/cc.h $S/algo/utils/shfl.h $S/d/api.h $S/inc/dev.h $B/conf.h $S/rigid/imp/main.h $S/algo/utils/dev.h $S/rigid/imp/type.h $S/utils/kl.h $S/rigid/dev/utils.h $S/rigid/dev/main.h $S/utils/msg.h
