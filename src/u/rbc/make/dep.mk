...
$B/rbc/force/imp.o: $S/rbc/force/imp/fin.h $S/rbc/force/params/lina.h $S/rbc/force/params/test.h $S/rbc/force/area_volume/imp.h $S/inc/conf.h $S/rbc/type.h $S/inc/type.h $S/rbc/force/dev/shape.h $S/rbc/force/imp.h $S/utils/cc.h $S/inc/def.h $S/rbc/force/imp/ini.h $S/rbc/force/dev/forces.h $S/rbc/adj/dev.h $S/d/api.h $S/msg.h $S/inc/dev.h $B/conf.h $S/utils/texo.h $S/rbc/force/imp/forces.h $S/utils/texo.dev.h $S/utils/te.h $S/utils/kl.h $S/math/dev.h $S/rbc/adj/type.h $S/rbc/force/dev/main.h $S/d/ker.h
