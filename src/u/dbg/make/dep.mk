...
$B/dbg/imp.o: $B/conf.h $S/coords/imp.h $S/coords/type.h $S/d/api.h $S/dbg/dev/clist.h $S/dbg/dev/color.h $S/dbg/dev/common.h $S/dbg/dev/force.h $S/dbg/dev/pos.h $S/dbg/dev/vel.h $S/dbg/error.h $S/dbg/imp.h $S/dbg/imp/main.h $S/dbg/imp/type.h $S/inc/conf.h $S/inc/def.h $S/inc/dev.h $S/inc/type.h $S/io/punto/imp.h $S/utils/cc.h $S/utils/error.h $S/utils/imp.h $S/utils/kl.h $S/utils/msg.h
...
$B/u/dbg/main.o: $B/conf.h $S/coords/ini.h $S/d/api.h $S/dbg/imp.h $S/inc/conf.h $S/inc/dev.h $S/inc/type.h $S/mpi/glb.h $S/mpi/wrapper.h $S/parser/imp.h $S/utils/cc.h $S/utils/error.h $S/utils/kl.h $S/utils/msg.h
