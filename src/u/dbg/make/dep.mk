...
$B/dbg/conf.o: $S/utils/error.h $S/dbg/imp.h $S/parser/imp.h
$B/dbg/imp.o: $S/dbg/dev/clist.h $S/io/punto/imp.h $S/coords/type.h $S/utils/imp.h $S/inc/conf.h $S/dbg/dev/common.h $S/dbg/error.h $S/utils/error.h $S/dbg/dev/vel.h $S/inc/type.h $S/dbg/imp.h $S/utils/cc.h $S/inc/def.h $S/dbg/dev/color.h $S/d/api.h $S/inc/dev.h $B/conf.h $S/dbg/imp/main.h $S/dbg/dev/force.h $S/dbg/dev/pos.h $S/dbg/imp/type.h $S/utils/kl.h $S/coords/imp.h $S/utils/msg.h
...
$B/u/dbg/main.o: $S/inc/conf.h $S/utils/error.h $S/inc/type.h $S/dbg/imp.h $S/mpi/wrapper.h $S/coords/ini.h $S/utils/cc.h $S/inc/dev.h $S/d/api.h $B/conf.h $S/utils/kl.h $S/parser/imp.h $S/mpi/glb.h $S/utils/msg.h
