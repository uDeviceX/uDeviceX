...
$B/fluforces/bulk/imp.o: $B/conf.h $S/d/api.h $S/d/ker.h $S/fluforces/bulk/dev/main.h $S/fluforces/bulk/imp.h $S/fluforces/bulk/imp/main.h $S/fluforces/bulk/imp/type.h $S/forces/imp.h $S/forces/pack.h $S/forces/type.h $S/inc/conf.h $S/inc/def.h $S/inc/dev.h $S/inc/type.h $S/math/rnd/dev.h $S/math/rnd/imp.h $S/utils/cc.h $S/utils/error.h $S/utils/kl.h $S/utils/texo.dev.h $S/utils/texo.h
...
$B/fluforces/imp.o: $S/cloud/imp.h $B/conf.h $S/d/api.h $S/flu/type.h $S/fluforces/bulk/imp.h $S/fluforces/dev/main.h $S/fluforces/halo/imp.h $S/fluforces/imp.h $S/fluforces/imp/fin.h $S/fluforces/imp/ini.h $S/fluforces/imp/main.h $S/fluforces/imp/type.h $S/frag/imp.h $S/inc/conf.h $S/inc/dev.h $S/inc/type.h $S/math/rnd/dev.h $S/math/rnd/imp.h $S/mpi/glb.h $S/mpi/wrapper.h $S/utils/cc.h $S/utils/error.h $S/utils/imp.h $S/utils/kl.h $S/utils/mc.h $S/utils/msg.h
...
$B/u/bulk/main.o: $S/clist/imp.h $S/cloud/imp.h $B/conf.h $S/coords/imp.h $S/coords/ini.h $S/d/api.h $S/flu/type.h $S/fluforces/imp.h $S/inc/conf.h $S/inc/dev.h $S/inc/type.h $S/io/txt/imp.h $S/mpi/glb.h $S/mpi/wrapper.h $S/parser/imp.h $S/partlist/type.h $S/utils/cc.h $S/utils/error.h $S/utils/imp.h $S/utils/msg.h
