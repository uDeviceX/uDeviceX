O = $B/algo/minmax/imp.o $B/algo/scan/imp.o $B/clist/imp.o $B/cnt/imp.o \
    ...
    $B/d/api.o $B/dbg/imp.o $B/distr/flu/imp.o $B/distr/map/imp.o \
    $B/distr/rbc/imp.o $B/distr/rig/imp.o $B/exch/flu/imp.o $B/exch/mesh/imp.o \
    $B/exch/obj/imp.o $B/flu/imp.o $B/fluforces/bulk/imp.o \
    ...
    $B/io/restart/imp.o $B/io/rig/imp.o $B/main.o $B/math/linal/imp.o \
    $B/math/rnd/imp.o $B/math/tform/imp.o $B/mesh/bbox.o $B/mesh/collision.o \
    $B/mesh/dist.o $B/mesh/props.o $B/meshbb/imp.o $B/mpi/glb.o $B/mpi/type.o \
    $B/mpi/wrapper.o $B/parser/imp.o $B/rbc/adj/imp.o $B/rbc/com/imp.o \
    $B/rbc/edg/imp.o $B/rbc/force/area_volume/imp.o $B/rbc/force/imp.o \
    $B/rbc/gen/imp.o $B/rbc/main/anti/imp.o $B/rbc/main/imp.o \
    $B/rbc/rnd/api/imp.o $B/rbc/rnd/imp.o $B/rbc/stretch/imp.o $B/rig/imp.o \
