...
void meshbb_select_collisions(float dt, int n, /**/ MeshBB *d);
...
// tag::collect[]
void meshbb_collect_rig_momentum(float dt, int ns, int nt, int nv, const int4 *tt, const Particle *pp, const Momentum *mm, /**/ Solid *ss);
