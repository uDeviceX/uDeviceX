...
int init(Particle *pp, int n, Particle **w_pp) {
...
void interactions(const int type, const Particle *const pp, const int n, const float rnd, const x::Clist *cells, const Particle *w_pp000, Force *ff) {
    if (n > 0 && w_n > 0) {
