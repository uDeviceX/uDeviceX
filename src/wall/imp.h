...
void wall_force(const PairParams*, WvelStep wv, const Coords *c, Sdf *qsdf, const WallQuants *q, const WallTicket *t, int n, const PaArray *parray, const FoArray *farray);
