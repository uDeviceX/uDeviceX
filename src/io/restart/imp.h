...
// tag::write[]
void restart_write_pp(MPI_Comm, const char *code, int id, long n, const Particle *pp); // <1>
void restart_write_ii(MPI_Comm, const char *code, int id, long n, const int *ii);      // <2>
