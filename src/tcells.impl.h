namespace tcells // [t]riangle cells
{
...
#define BBOX_MARGIN 0.1f
    ...
    static void countt(const int nt, const int *tt, const Particles *pp, const int ns, /**/ int *counts)
    {
...
#undef loadr
    ...
    static void fill_ids(const int nt, const int *tt, const Particles *pp, const int ns, const int *starts, /**/ int *counts, int *ids)
    {
        memset(counts, 0, NCELLS * sizeof(int));
...
#undef loadr
    ...
    int build_hst(const Mesh m, const Particle *i_pp, const int ns, /**/ int *counts, int *starts, int *ids)
    {
