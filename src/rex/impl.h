...
void _postrecvC(MPI_Comm cart, int ranks[26]) {
    for (int i = 0; i < 26; ++i) {
        MPI_Request reqC;
...
void recv_p(MPI_Comm cart, int ranks[26]) {
    _wait(reqrecvC);
    _wait(reqrecvP);
