...
static void create_solids(Coords coords, MPI_Comm cart, flu::FluQuants* qflu, rig::Quants* qrig) {
...
void freeze(Coords coords, MPI_Comm cart, Sdf *sdf, flu::FluQuants *qflu, rig::Quants *qrig, rbc::Quants *qrbc) {
    MC(m::Barrier(cart));
