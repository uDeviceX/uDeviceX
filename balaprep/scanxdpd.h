...
__global__ void excl26scan(int *d_data30,  int *d_output30,
                              int *d_data31,  int *d_output31,
                              int *d_data32,  int *d_output32,
                              int *d_data33,  int *d_output33,
                              int *d_data34,  int *d_output34,
                              int *d_data35,  int *d_output35,
                              int *d_data0, int *d_output0,
                              int *d_data1, int *d_output1,
                              int *d_data2, int *d_output2,
                              int *d_data3, int *d_output3,
                              int *d_data4, int *d_output4,
