...
one vertices.  `Adj_v` has an API call which allow for a given thread
...
is a structure which contains five indices and an ID of the mesh:
...
`01`, triangle `012`, and two dihedrals `0124` and `1203`. For example
the contribution of edge `01`.
v