...
namespace CudaRBC
{
	...
	void setup(int& nvertices, Extent& host_extent)
	{
		...
		unitsSetup(1.64, 0.00141, 19.0476, 200, 80104.168, 80059.0438, 0, 660, 1596, 1e-6, 2.4295e-6, 4, report); //unitsSetup(1.64, 0.00705, 6, 15, 1000, 5000, 5, 135, 90, 1e-6, 1e-5, 4, report);
	}
