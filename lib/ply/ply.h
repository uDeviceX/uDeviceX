...
enum {PLY_ASCII = 1, PLY_BINARY_BE  = 2, PLY_BINARY_LE = 3};
enum {PLY_OKAY = 0, PLY_ERROR  = -1};

/* scalar data types supported by PLY format */
enum { PLY_START_TYPE = 0, PLY_CHAR = 1, PLY_SHORT= 2,
       PLY_INT = 3, PLY_UCHAR = 4, PLY_USHORT = 5,
       PLY_UINT = 6, PLY_FLOAT = 7, PLY_DOUBLE = 8, PLY_END_TYPE = 9};

/* return codes */
enum {PLY_SCALAR = 0, PLY_LIST = 1};
